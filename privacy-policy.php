...
<div class="container">
    <div class="mx-auto mt-4 text-light pt-5 pb-5 mb-3">
        ...
        <p>Diese Datenschutzerklärung gilt für die Citizen-Science-Plattform "Kino Karte", erreichbar unter
            "webadresse" .</p>
        ...
        <p>
            Bitte hier Datenschutzhinweis einfügen.
        </p>
        <h3>
            Verschlüsselung
        </h3>
        ...
        <p>
            Bitte Datenschutzanmerkungen zum Kontaktformular hier einfügen!
        </p>
    </div>
</div>
</body>
