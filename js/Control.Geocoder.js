...
this.L.Control.Geocoder = (function (L) {
    ...
    var Geocoder = L.Control.extend({
        ...
        /**
         * places marker on map and on minimap
         *
         * @param result
         * @returns {Geocoder}
         */
        ...
        _geocode: function(suggest) {
            ...
            let _t = null; // temp json data
            let c = false; // clear done
            let _cinema_search_result = function(a){
                ...
                if (c && _t){
                    mergedSearchModal(_t);
                }
            }
            //request cinemas data
            asyncApiRequest({type: "gpu"}, _cinema_search_result);
        ...
        _keydown: function(e) {
            ...
            switch (e.keyCode) {
                ...
                case 13:
                    if (this._selection) {
                        delMark();
                        if (this._selection.hasAttribute('data-result-index')){
                            ...
                            {
                                this._selection.dispatchEvent(new Event('mousedown'));
                            }
                            else{  //IE
                                this._selection.fireEvent("onmousedown", this._selection);
                            }
